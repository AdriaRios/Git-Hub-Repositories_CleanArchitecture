...
public class SQLiteDataRepository {
     ...
     */
    public Cursor fetchAllReposPerPage(String[] projection, String selection) {

        Cursor result = this.databaseOpenHelper.getReadableDatabase()
                .query(
                        DatabaseOpenHelper.REPOSITORY_TABLE_NAME,
                        projection,
                        DatabaseOpenHelper.PAGE +" = " + selection,
                        null,
                        null,
                        null,
    ...
    public int delete(String selection) {
        return this.sqliteDatabase.delete(DatabaseOpenHelper.REPOSITORY_TABLE_NAME, selection, null);
    }

    public int update(ContentValues values, String selection) {
        return this.sqliteDatabase.update(DatabaseOpenHelper.REPOSITORY_TABLE_NAME, values, selection, null);
    }
